...
<div class="container">
    ...
    <form action={{route('adminEdition', ['modif'=>$articles->id])}} method="post">
        ...
        <div class="form-group">
            ...
            <input  id="decription" type="text" name="description"  class="form-control" value="{{$articles->description}}" required>
        </div>
        ...
        <div class="form-group">
            ...
            <input  id="prix" min=0 type="number" name="prix"  class="form-control" value="{{$articles->price}}" required>
        </div>
        
        <div class="form-group">
            <label for="poids">Weight</label><br>
            <input  id="weight" min=0 type="number" name="poids"  class="form-control" value="{{$articles->weight}}" required>
        </div>
        
        <div class="form-group">
            <label for="stock">Stock</label><br>
            <input  id="stock" min=0 type="number" name="stock"  class="form-control" value="{{$articles->stock}}" required>
        </div>
