                        ...
                        {{-- @if ($errors->any())
                            ...
                            <div class="form-row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="name" placeholder="Prénom" name="first_name" value="{{Auth::User()->customer->first_name}}" required>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="validationDefault02">Nom</label>
                                    <input type="text" class="form-control" id="last_name" placeholder="Nom" name="name" value="{{Auth::User()->customer->name}}" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="validationDefaultUsername" placeholder="mail" aria-describedby="inputGroupPrepend2" name="email" value="{{Auth::User()->email}}"required>
                                    </div>
                                </div>
                            </div>
