...
Route::prefix('admin')->group(function () { // prefix url ex: admin/categories
    ...
    Route::put('produit/store', 'AdminProductsController@storeProd')->name('adminProductStore');
    ...
    Route::delete('produit/delete/{id}', 'AdminProductsController@destroyProd')->name('adminProductDestroy');
